        ...
        <Modal state={state}>
            <ContainModal className="bg-gray-50 max-w-3xl w-full h-[90vh] md:h-auto md:max-h-[90vh] rounded-2xl overflow-hidden shadow-2xl flex flex-col">               
                <div className="relative w-full flex-none ">
                    ...
                    <div className=" inset-0 flex flex-col justify-end px-6 py-2 text-black">
                        <h3 className='font-bold text-xl mb-1.5'>{gameData?.tournament_nombre || 'Torneo'}</h3>
                        <div className='flex items-center gap-3 justify-start mb-2'>
                            <h2 className="text-xmd md:text-md font-bold text-start truncate">
                                {gameData ? `${gameData.competidor_a.nombre} vs ${gameData.competidor_b.nombre}` : 'Detalles del Partido'}
                            </h2>
                            <p className="text-xs font-bold uppercase tracking-wider text-unimar">
