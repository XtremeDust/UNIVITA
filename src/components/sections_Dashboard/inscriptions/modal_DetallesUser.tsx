...
export default function Modal_DetallesUser({ state, onClose, user }: ModalProps) {
    ...
    return (
        <Modal state={state} >
            <ContainModal className="w-full max-w-lg bg-white rounded-xl shadow-2xl flex flex-col max-h-[90vh] sm:max-h-[85vh]  overflow-y-auto text-black">
                <HeaderModal onClose={onClose} className='relative'>
                    <h2 className=" absolute top-0 text-xl font-bold text-gray-800">Detalles del Usuario</h2>
                </HeaderModal>
                
                <div className="px-6 py-3 flex flex-col items-center space-y-2">
