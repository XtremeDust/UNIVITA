...
export default function Comment() {
    ...
    const handleSave = async () => {
        ...
        if (!email.includes('@unimar.edu.ve')) {
            toast.error("Usa tu correo institucional @unimar.edu.ve");
        ...
        const saveCommentPromise = new Promise(async (resolve, reject) => {
            try {
                ...
                if (!res.ok) {
                    ...
                    reject(new Error(errData.message || 'Error al guardar'));
                }
                else {
                    resolve(res);
                }
        ...
        toast.promise(saveCommentPromise, {
