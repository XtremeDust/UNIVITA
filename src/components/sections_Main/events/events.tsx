                ...
                {loadingEvents ? (
                    ...
                    tournaments.map((card) => (
                        <ActiveLink key={card.id} href={`events/${card.id}`}>
                            <Card className="relative bg-white max-w-xs cursor-pointer rounded-lg overflow-hidden shadow-lg transform transition-transform duration-300 hover:scale-104">
                                <div className="relative bg-white w-80  h-52 cursor-pointer rounded-lg overflow-hidden">
