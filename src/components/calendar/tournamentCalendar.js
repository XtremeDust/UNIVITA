...
export default function CustomTournamentCalendar() {
  ...
  return (
    <div className="max-w-2xl mx-auto bg-white rounded-3xl shadow-2xl overflow-hidden border border-slate-100 font-sans">
      
      {/* HEADER */}
      <div className="bg-univita p-6 text-white">
      ...
      <div className="p-6">
        ...
        <button 
            ...
            className="w-full mt-4 bg-univita/80 text-white font-bold py-3.5 rounded-xl hover:bg-univita disabled:bg-univita/20 disabled:text-slate-400 transition-all shadow-lg disabled:shadow-none"
        >
            Confirmar Reserva
        </button>
